...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-04-2023 a las 04:23:37
...
(9, 9112001, 15616, 3636),
(10, 9112001, 125445, 3636);
...
(15616, 'RC', 'JHONATAN', 'MUENTES', 'jhonatanz@gmail.com', 3045478584, 'M', '1998-06-01', 24),
(123456, 'CC', 'LUCIA DEL CARMEN', 'VASQUEZ TIRADO', 'sofiavargasmadrid@hotmail', 343535354, 'F', '2001-10-16', 20),
(125445, 'TI', 'JHON', 'FAJARDO', 'fajardo@gmail.com', 3056547895, 'F', '2000-07-21', 22),
(154245, 'CC', 'JHON BREYNER', 'CASTRO VIVERO', 'JhonBreyner@gmail.com', 3054576595, 'M', '1997-07-29', 25),
(444444, 'CE', 'VANESA ALEXANDRA', 'MéNDEZ PADILLA', 'VanesaAlexandra@gmail.com', 3061245748, 'F', '2002-08-21', 20),
...
(9, 3636, 15616, 9112001, 'Confirmado'),
(10, 3636, 444444, 9112001, 'Reservado'),
(11, 3636, 125445, 9112001, 'Confirmado');
...
(2323, '2023-04-05', 'Montería', 'Santa marta', 1, 0, 450000),
(3636, '2023-04-04', 'Montería', 'Medellín', 2, 1, 1250000),
...
(123453, 'MEXICOAIRLINEPLUZ', 20),
(9112001, 'AMERICAN ARILINES', 100);
...
--
ALTER TABLE `checkin`
  MODIFY `Cod_checkIn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `detallereserva`
--
ALTER TABLE `detallereserva`
  MODIFY `idDet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
